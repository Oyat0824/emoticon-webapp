...
- [이모티콘 웹 애플리케이션](#이모티콘-웹-애플리케이션)
	...
	- [서버 배포](#서버-배포)
		- [1. 서버 준비](#1-서버-준비)
			- [Node.js 설치 (nvm 사용)](#nodejs-설치-nvm-사용)
			- [PM2 설치](#pm2-설치)
			- [Nginx 설치](#nginx-설치)
		- [2. 프로젝트 배포](#2-프로젝트-배포)
		...
		- [6. HTTPS 설정](#6-https-설정)
			...
			- [인증서 자동 갱신 확인](#인증서-자동-갱신-확인)
	- [이모티콘 관리](#이모티콘-관리)
		- [이모티콘 추가](#이모티콘-추가)
		- [이모티콘 삭제](#이모티콘-삭제)
	- [도메인 관리](#도메인-관리)
		- [도메인 갱신 (같은 도메인 유지)](#도메인-갱신-같은-도메인-유지)
		- [도메인 변경 (새 도메인 사용)](#도메인-변경-새-도메인-사용)
		- [도메인 만료 시](#도메인-만료-시)
	- [문제 해결](#문제-해결)
		- [포트 충돌](#포트-충돌)
		- [Nginx 502 오류](#nginx-502-오류)
		- [권한 문제](#권한-문제)
		- [클립보드 복사 안 될 때](#클립보드-복사-안-될-때)
	- [기술 스택](#기술-스택)
